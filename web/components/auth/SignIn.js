...
export default function SignIn() {
    ...
    return (
        <Flex height="100vh" align="center" justify="center" backgroundColor="gray.700">
                <VStack className="noselect" background="gray.100" p="3rem" align="center" justify="center" spacing="1rem">
                    ...
                    <Alert status="error" rounded="1rem" justify="center" align="center" width="fit-content">
                        <AlertIcon/>
                    ...
                    <Flex justify="space-between" width="100%" direction="row"> 
                        ...
                        <p><Link style={{textDecoration: 'inherit'}}>Forgot Password</Link></p>
                    </Flex>
                </VStack>
        </Flex>
    )
